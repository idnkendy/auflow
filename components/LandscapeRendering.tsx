...
const gardenStyleOptions = [
    ...
    { value: 'vườn Zen Nhật Bản', label: 'Vườn Zen Nhật Bản' },
    { value: 'vườn nhiệt đới rậm rạp', label: 'Vườn nhiệt đới' },
    { value: 'sân vườn Anh Quốc cổ điển', label: 'Vườn Anh cổ điển' },
    { value: 'sân vườn hiện đại, tối giản', label: 'Sân vườn hiện đại' },
    { value: 'vườn Địa Trung Hải', label: 'Vườn Địa Trung Hải' },
    { value: 'vườn làng quê Việt Nam', label: 'Vườn quê Việt Nam' },
];

const timeOfDayOptions = [
    { value: 'none', label: 'Chưa chọn' },
    { value: 'ban ngày nắng đẹp', label: 'Ban ngày nắng đẹp' },
    { value: 'hoàng hôn (giờ vàng)', label: 'Hoàng hôn (giờ vàng)' },
    { value: 'ban đêm với đèn sân vườn', label: 'Ban đêm có đèn hắt' },
    { value: 'ngày u ám, nhiều mây', label: 'Ngày u ám' },
    { value: 'sau cơn mưa, mặt đất ẩm ướt', label: 'Sau cơn mưa' },
];

const featureOptions = [
    { value: 'none', label: 'Chưa chọn' },
    { value: 'có một hồ cá Koi nhỏ', label: 'Có hồ cá Koi' },
    { value: 'có lối đi bằng đá cuội', label: 'Có lối đi bằng đá' },
    { value: 'có một giàn hoa giấy', label: 'Có giàn hoa' },
    { value: 'có khu vực BBQ ngoài trời', label: 'Có khu vực BBQ' },
    { value: 'có một thác nước nhỏ', label: 'Có thác nước' },
    { value: 'có nhiều loại hoa đầy màu sắc', label: 'Có nhiều hoa màu sắc' },
];
                         ...
                         <div className="space-y-4 flex flex-col">
                            ...
                            <div className="pt-2">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <OptionSelector id="style-selector" label="Phong cách vườn" options={gardenStyleOptions} value={gardenStyle} onChange={handleGardenStyleChange} disabled={isLoading} />
                                    <OptionSelector id="time-selector" label="Thời gian trong ngày" options={timeOfDayOptions} value={timeOfDay} onChange={handleTimeOfDayChange} disabled={isLoading} />
                                    <OptionSelector id="feature-selector" label="Thêm chi tiết" options={featureOptions} value={features} onChange={handleFeaturesChange} disabled={isLoading} />
                                </div>
                            </div>
